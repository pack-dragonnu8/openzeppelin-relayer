//! # Vault Signer for Stellar
//!
//! This module provides an Stellar signer implementation that uses HashiCorp Vault's KV2 engine
...
/// Stellar signer that fetches private keys from HashiCorp Vault KV2 engine
#[derive(Clone)]
...
mod tests {
    use super::*;
    use crate::models::{SecretString, VaultSignerConfig};
