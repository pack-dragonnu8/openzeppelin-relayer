...
- Google Cloud KMS: link:https://github.com/OpenZeppelin/openzeppelin-relayer/tree/main/examples/stellar-gcp-kms-signer[stellar-gcp-kms-signer example]
- Turnkey: link:https://github.com/OpenZeppelin/openzeppelin-relayer/tree/main/examples/stellar-turnkey-signer[stellar-turnkey-signer example]
